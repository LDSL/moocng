...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BadgeByCourse.image'
        db.add_column('badges_badgebycourse', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BadgeByCourse.image'
        db.delete_column('badges_badgebycourse', 'image')
    ...
    models = {
        ...
        'badges.award': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cd1fca76-2a1b-11e5-a589-08002759738a'", 'max_length': '255', 'db_index': 'True'})
        },
        'badges.badge': {
