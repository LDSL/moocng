...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_userprofile', 'twitter',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.facebook'
        db.add_column('profile_userprofile', 'facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.linkedin'
        db.add_column('profile_userprofile', 'linkedin',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profile_userprofile', 'twitter')

        # Deleting field 'UserProfile.facebook'
        db.delete_column('profile_userprofile', 'facebook')

        # Deleting field 'UserProfile.linkedin'
        db.delete_column('profile_userprofile', 'linkedin')
    ...
    models = {
        ...
        'profile.userprofile': {
            ...
            'facebook': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            ...
            'twitter': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
