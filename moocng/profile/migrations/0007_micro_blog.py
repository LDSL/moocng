...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db = get_micro_blog_db()
        post = db.get_collection('post')
        post.create_index([('date', pymongo.DESCENDING)])
        post.create_index([('id_user', pymongo.ASCENDING)])

        user = db.get_collection('user')
        user.create_index([('id_user', pymongo.ASCENDING)])
