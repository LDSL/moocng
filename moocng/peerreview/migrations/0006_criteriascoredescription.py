...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EvaluationCriterion.description_score_1'
        db.add_column('peerreview_evaluationcriterion', 'description_score_1',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EvaluationCriterion.description_score_2'
        db.add_column('peerreview_evaluationcriterion', 'description_score_2',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EvaluationCriterion.description_score_3'
        db.add_column('peerreview_evaluationcriterion', 'description_score_3',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EvaluationCriterion.description_score_4'
        db.add_column('peerreview_evaluationcriterion', 'description_score_4',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EvaluationCriterion.description_score_5'
        db.add_column('peerreview_evaluationcriterion', 'description_score_5',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EvaluationCriterion.description_score_1'
        db.delete_column('peerreview_evaluationcriterion', 'description_score_1')

        # Deleting field 'EvaluationCriterion.description_score_2'
        db.delete_column('peerreview_evaluationcriterion', 'description_score_2')

        # Deleting field 'EvaluationCriterion.description_score_3'
        db.delete_column('peerreview_evaluationcriterion', 'description_score_3')

        # Deleting field 'EvaluationCriterion.description_score_4'
        db.delete_column('peerreview_evaluationcriterion', 'description_score_4')

        # Deleting field 'EvaluationCriterion.description_score_5'
        db.delete_column('peerreview_evaluationcriterion', 'description_score_5')
