...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticPage.title_en'
        db.add_column('courses_staticpage', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.title_es'
        db.add_column('courses_staticpage', 'title_es',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.title_it'
        db.add_column('courses_staticpage', 'title_it',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.title_pt'
        db.add_column('courses_staticpage', 'title_pt',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.title_fr'
        db.add_column('courses_staticpage', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.title_de'
        db.add_column('courses_staticpage', 'title_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.body_en'
        db.add_column('courses_staticpage', 'body_en',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.body_es'
        db.add_column('courses_staticpage', 'body_es',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.body_it'
        db.add_column('courses_staticpage', 'body_it',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.body_pt'
        db.add_column('courses_staticpage', 'body_pt',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.body_fr'
        db.add_column('courses_staticpage', 'body_fr',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticPage.body_de'
        db.add_column('courses_staticpage', 'body_de',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaticPage.title_en'
        db.delete_column('courses_staticpage', 'title_en')

        # Deleting field 'StaticPage.title_es'
        db.delete_column('courses_staticpage', 'title_es')

        # Deleting field 'StaticPage.title_it'
        db.delete_column('courses_staticpage', 'title_it')

        # Deleting field 'StaticPage.title_pt'
        db.delete_column('courses_staticpage', 'title_pt')

        # Deleting field 'StaticPage.title_fr'
        db.delete_column('courses_staticpage', 'title_fr')

        # Deleting field 'StaticPage.title_de'
        db.delete_column('courses_staticpage', 'title_de')

        # Deleting field 'StaticPage.body_en'
        db.delete_column('courses_staticpage', 'body_en')

        # Deleting field 'StaticPage.body_es'
        db.delete_column('courses_staticpage', 'body_es')

        # Deleting field 'StaticPage.body_it'
        db.delete_column('courses_staticpage', 'body_it')

        # Deleting field 'StaticPage.body_pt'
        db.delete_column('courses_staticpage', 'body_pt')

        # Deleting field 'StaticPage.body_fr'
        db.delete_column('courses_staticpage', 'body_fr')

        # Deleting field 'StaticPage.body_de'
        db.delete_column('courses_staticpage', 'body_de')
