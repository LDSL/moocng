...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.title_en'
        db.add_column('courses_unit', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.title_es'
        db.add_column('courses_unit', 'title_es',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.title_it'
        db.add_column('courses_unit', 'title_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.title_pt'
        db.add_column('courses_unit', 'title_pt',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.title_fr'
        db.add_column('courses_unit', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.title_de'
        db.add_column('courses_unit', 'title_de',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Unit.title_en'
        db.delete_column('courses_unit', 'title_en')

        # Deleting field 'Unit.title_es'
        db.delete_column('courses_unit', 'title_es')

        # Deleting field 'Unit.title_it'
        db.delete_column('courses_unit', 'title_it')

        # Deleting field 'Unit.title_pt'
        db.delete_column('courses_unit', 'title_pt')

        # Deleting field 'Unit.title_fr'
        db.delete_column('courses_unit', 'title_fr')

        # Deleting field 'Unit.title_de'
        db.delete_column('courses_unit', 'title_de')
