...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseStudent.progress'
        db.add_column('courses_coursestudent', 'progress',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseStudent.progress'
        db.delete_column('courses_coursestudent', 'progress')
