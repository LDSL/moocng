...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CourseLanguage'
        db.delete_table('courses_courselanguage')

        # Adding M2M table for field languages on 'Course'
        db.create_table('courses_course_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['courses.course'], null=False)),
            ('language', models.ForeignKey(orm['courses.language'], null=False))
        ))
        db.create_unique('courses_course_languages', ['course_id', 'language_id'])


    def backwards(self, orm):
        # Adding model 'CourseLanguage'
        db.create_table('courses_courselanguage', (
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Language'])),
        ))
        db.send_create_signal('courses', ['CourseLanguage'])

        # Removing M2M table for field languages on 'Course'
        db.delete_table('courses_course_languages')
