...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.certification_banner'
        db.delete_column('courses_course', 'certification_banner')

        # Deleting field 'Course.certification_available'
        db.delete_column('courses_course', 'certification_available')
    ...
    def backwards(self, orm):
        # Adding field 'Course.certification_banner'
        db.add_column('courses_course', 'certification_banner',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.certification_available'
        db.add_column('courses_course', 'certification_available',
