...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('courses_course', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.name_es'
        db.add_column('courses_course', 'name_es',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.name_it'
        db.add_column('courses_course', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.name_pt'
        db.add_column('courses_course', 'name_pt',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.name_fr'
        db.add_column('courses_course', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.name_de'
        db.add_column('courses_course', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.description_en'
        db.add_column('courses_course', 'description_en',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.description_es'
        db.add_column('courses_course', 'description_es',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.description_it'
        db.add_column('courses_course', 'description_it',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.description_pt'
        db.add_column('courses_course', 'description_pt',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.description_fr'
        db.add_column('courses_course', 'description_fr',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.description_de'
        db.add_column('courses_course', 'description_de',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.requirements_en'
        db.add_column('courses_course', 'requirements_en',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.requirements_es'
        db.add_column('courses_course', 'requirements_es',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.requirements_it'
        db.add_column('courses_course', 'requirements_it',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.requirements_pt'
        db.add_column('courses_course', 'requirements_pt',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.requirements_fr'
        db.add_column('courses_course', 'requirements_fr',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.requirements_de'
        db.add_column('courses_course', 'requirements_de',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.learning_goals_en'
        db.add_column('courses_course', 'learning_goals_en',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.learning_goals_es'
        db.add_column('courses_course', 'learning_goals_es',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.learning_goals_it'
        db.add_column('courses_course', 'learning_goals_it',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.learning_goals_pt'
        db.add_column('courses_course', 'learning_goals_pt',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.learning_goals_fr'
        db.add_column('courses_course', 'learning_goals_fr',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.learning_goals_de'
        db.add_column('courses_course', 'learning_goals_de',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.estimated_effort_en'
        db.add_column('courses_course', 'estimated_effort_en',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.estimated_effort_es'
        db.add_column('courses_course', 'estimated_effort_es',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.estimated_effort_it'
        db.add_column('courses_course', 'estimated_effort_it',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.estimated_effort_pt'
        db.add_column('courses_course', 'estimated_effort_pt',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.estimated_effort_fr'
        db.add_column('courses_course', 'estimated_effort_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.estimated_effort_de'
        db.add_column('courses_course', 'estimated_effort_de',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('courses_course', 'name_en')

        # Deleting field 'Course.name_es'
        db.delete_column('courses_course', 'name_es')

        # Deleting field 'Course.name_it'
        db.delete_column('courses_course', 'name_it')

        # Deleting field 'Course.name_pt'
        db.delete_column('courses_course', 'name_pt')

        # Deleting field 'Course.name_fr'
        db.delete_column('courses_course', 'name_fr')

        # Deleting field 'Course.name_de'
        db.delete_column('courses_course', 'name_de')

        # Deleting field 'Course.description_en'
        db.delete_column('courses_course', 'description_en')

        # Deleting field 'Course.description_es'
        db.delete_column('courses_course', 'description_es')

        # Deleting field 'Course.description_it'
        db.delete_column('courses_course', 'description_it')

        # Deleting field 'Course.description_pt'
        db.delete_column('courses_course', 'description_pt')

        # Deleting field 'Course.description_fr'
        db.delete_column('courses_course', 'description_fr')

        # Deleting field 'Course.description_de'
        db.delete_column('courses_course', 'description_de')

        # Deleting field 'Course.requirements_en'
        db.delete_column('courses_course', 'requirements_en')

        # Deleting field 'Course.requirements_es'
        db.delete_column('courses_course', 'requirements_es')

        # Deleting field 'Course.requirements_it'
        db.delete_column('courses_course', 'requirements_it')

        # Deleting field 'Course.requirements_pt'
        db.delete_column('courses_course', 'requirements_pt')

        # Deleting field 'Course.requirements_fr'
        db.delete_column('courses_course', 'requirements_fr')

        # Deleting field 'Course.requirements_de'
        db.delete_column('courses_course', 'requirements_de')

        # Deleting field 'Course.learning_goals_en'
        db.delete_column('courses_course', 'learning_goals_en')

        # Deleting field 'Course.learning_goals_es'
        db.delete_column('courses_course', 'learning_goals_es')

        # Deleting field 'Course.learning_goals_it'
        db.delete_column('courses_course', 'learning_goals_it')

        # Deleting field 'Course.learning_goals_pt'
        db.delete_column('courses_course', 'learning_goals_pt')

        # Deleting field 'Course.learning_goals_fr'
        db.delete_column('courses_course', 'learning_goals_fr')

        # Deleting field 'Course.learning_goals_de'
        db.delete_column('courses_course', 'learning_goals_de')

        # Deleting field 'Course.estimated_effort_en'
        db.delete_column('courses_course', 'estimated_effort_en')

        # Deleting field 'Course.estimated_effort_es'
        db.delete_column('courses_course', 'estimated_effort_es')

        # Deleting field 'Course.estimated_effort_it'
        db.delete_column('courses_course', 'estimated_effort_it')

        # Deleting field 'Course.estimated_effort_pt'
        db.delete_column('courses_course', 'estimated_effort_pt')

        # Deleting field 'Course.estimated_effort_fr'
        db.delete_column('courses_course', 'estimated_effort_fr')

        # Deleting field 'Course.estimated_effort_de'
        db.delete_column('courses_course', 'estimated_effort_de')
