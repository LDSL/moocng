...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.official_course'
        db.add_column('courses_course', 'official_course',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.official_course'
        db.delete_column('courses_course', 'official_course')
