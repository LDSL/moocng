...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('courses_course', 'estimated_effort', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Course.estimated_effort'
        db.alter_column('courses_course', 'estimated_effort', self.gf('tinymce.models.HTMLField')(null=True))
