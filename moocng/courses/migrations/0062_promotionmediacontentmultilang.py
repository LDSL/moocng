...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.promotion_media_content_id_en'
        db.add_column('courses_course', 'promotion_media_content_id_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.promotion_media_content_id_es'
        db.add_column('courses_course', 'promotion_media_content_id_es',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.promotion_media_content_id_it'
        db.add_column('courses_course', 'promotion_media_content_id_it',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.promotion_media_content_id_pt'
        db.add_column('courses_course', 'promotion_media_content_id_pt',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.promotion_media_content_id_fr'
        db.add_column('courses_course', 'promotion_media_content_id_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.promotion_media_content_id_de'
        db.add_column('courses_course', 'promotion_media_content_id_de',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.promotion_media_content_id_en'
        db.delete_column('courses_course', 'promotion_media_content_id_en')

        # Deleting field 'Course.promotion_media_content_id_es'
        db.delete_column('courses_course', 'promotion_media_content_id_es')

        # Deleting field 'Course.promotion_media_content_id_it'
        db.delete_column('courses_course', 'promotion_media_content_id_it')

        # Deleting field 'Course.promotion_media_content_id_pt'
        db.delete_column('courses_course', 'promotion_media_content_id_pt')

        # Deleting field 'Course.promotion_media_content_id_fr'
        db.delete_column('courses_course', 'promotion_media_content_id_fr')

        # Deleting field 'Course.promotion_media_content_id_de'
        db.delete_column('courses_course', 'promotion_media_content_id_de')
