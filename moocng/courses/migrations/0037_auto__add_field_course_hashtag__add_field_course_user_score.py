...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.hashtag'
        db.add_column('courses_course', 'hashtag',
                      self.gf('django.db.models.fields.CharField')(default='Hashtag', max_length=128),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Course.hashtag'
        db.delete_column('courses_course', 'hashtag')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'user_score': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'})
        },
