...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('courses_transcription', (
            ...
            ('transcription_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Language'])),
        ))
        db.send_create_signal('courses', ['Transcription'])

        # Deleting field 'Course.user_score'
        db.delete_column('courses_course', 'user_score')


    def backwards(self, orm):
        # Deleting model 'Transcription'
        db.delete_table('courses_transcription')

        # Adding field 'Course.user_score'
        db.add_column('courses_course', 'user_score',
