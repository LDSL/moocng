...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.external_certification_available'
        db.add_column('courses_course', 'external_certification_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.certification_file'
        db.add_column('courses_course', 'certification_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.external_certification_available'
        db.delete_column('courses_course', 'external_certification_available')

        # Deleting field 'Course.certification_file'
        db.delete_column('courses_course', 'certification_file')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'certification_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
