...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.intended_audience_en'
        db.add_column('courses_course', 'intended_audience_en',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.intended_audience_es'
        db.add_column('courses_course', 'intended_audience_es',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.intended_audience_it'
        db.add_column('courses_course', 'intended_audience_it',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.intended_audience_pt'
        db.add_column('courses_course', 'intended_audience_pt',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.intended_audience_fr'
        db.add_column('courses_course', 'intended_audience_fr',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.intended_audience_de'
        db.add_column('courses_course', 'intended_audience_de',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Course.intended_audience_en'
        db.delete_column('courses_course', 'intended_audience_en')

        # Deleting field 'Course.intended_audience_es'
        db.delete_column('courses_course', 'intended_audience_es')

        # Deleting field 'Course.intended_audience_it'
        db.delete_column('courses_course', 'intended_audience_it')

        # Deleting field 'Course.intended_audience_pt'
        db.delete_column('courses_course', 'intended_audience_pt')

        # Deleting field 'Course.intended_audience_fr'
        db.delete_column('courses_course', 'intended_audience_fr')

        # Deleting field 'Course.intended_audience_de'
        db.delete_column('courses_course', 'intended_audience_de')
