...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseStudent.timestamp'
        db.add_column('courses_coursestudent', 'timestamp',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'CourseStudent.pos_lat'
        db.add_column('courses_coursestudent', 'pos_lat',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CourseStudent.pos_lon'
        db.add_column('courses_coursestudent', 'pos_lon',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseStudent.timestamp'
        db.delete_column('courses_coursestudent', 'timestamp')

        # Deleting field 'CourseStudent.pos_lat'
        db.delete_column('courses_coursestudent', 'pos_lat')

        # Deleting field 'CourseStudent.pos_lon'
        db.delete_column('courses_coursestudent', 'pos_lon')
